...
namespace GPUTerrain
{
    ...
    public class MinMaxHeightMapEditorGenerator
    {
            ...
            get {
                if (!_computeShader) {
                    _computeShader = AssetDatabase.LoadAssetAtPath<ComputeShader>(
                        "Assets/GPUTerrain/Shader/MinMaxHeights.compute"
                        );
                }
        ...
        [MenuItem("Assets/Create/GPUTerrain/GenerateMinMaxHeightMapFromSelectedHeightMap")]
        ...
        private void CalculateGroupXY(int kernelIndex, int textureSize, out int groupX, out int groupY)
        {
        ...
        private void GeneratePatchMinMaxHeightTexMip0(System.Action<RenderTexture> callback) {
            ...
            int groupX, groupY;
            CalculateGroupXY(kernelIndex, patchMapSize, out groupX, out groupY);
        ...
        public void Generate() {
            ...
            GeneratePatchMinMaxHeightTexMip0(
                (rt) => {
                    textures.Add(rt);
        ...
        private void GenerateMipMap(RenderTexture inTex, System.Action<RenderTexture> callback)
        {
            ...
            int groupX, groupY;
            CalculateGroupXY(kernelIndex, reduceTex.width, out groupX, out groupY);
            computeShader.Dispatch(kernelIndex, groupX, groupY, 1);
